...
namespace Academy.Models.Utils
{
    public static class Validator
    {
        ...
        public static void ValidateIfNullOrEmpty(this object value, string msg = null)
        {
            if (msg == null)
            {
                msg = "Value cannot be null!";
        ...
        public static void ValidateMinAndMaxNumber(this float value, int min, int max = int.MaxValue - 1, string msg = null)
        {
            if (msg == null)
            {
                msg = string.Format("Value must be between {0} and {1}!", min, max);
